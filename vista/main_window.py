...
"color: rgb(255, 255, 255);")
        ...
        self.horizontalLayout.addWidget(self.bt_parentesis)
        self.bt_llaves = QtWidgets.QPushButton(self.fr_cerrar)
        self.bt_llaves.setMaximumSize(QtCore.QSize(0, 0))
        self.bt_llaves.setText("")
        self.bt_llaves.setObjectName("bt_llaves")
        self.horizontalLayout.addWidget(self.bt_llaves)
        self.bt_corchetes = QtWidgets.QPushButton(self.fr_cerrar)
        self.bt_corchetes.setMaximumSize(QtCore.QSize(0, 0))
        self.bt_corchetes.setText("")
        self.bt_corchetes.setObjectName("bt_corchetes")
        self.horizontalLayout.addWidget(self.bt_corchetes)
        self.bt_llaves2 = QtWidgets.QPushButton(self.fr_cerrar)
        self.bt_llaves2.setMinimumSize(QtCore.QSize(0, 0))
        self.bt_llaves2.setMaximumSize(QtCore.QSize(0, 0))
...
"}")
        ...
        self.bt_corchetes2.setMinimumSize(QtCore.QSize(0, 0))
        self.bt_corchetes2.setMaximumSize(QtCore.QSize(0, 0))
...
"}")
        ...
        self.bt_parentesis2.setMinimumSize(QtCore.QSize(0, 0))
        self.bt_parentesis2.setMaximumSize(QtCore.QSize(0, 0))
...
"font:  Bold 45pt \"Montserrat\";")
        ...
        ''' ALINEADO A LA DERECHA DEL TEXTO OUTPUT '''
        # Configurar alineación del texto a la derecha
...
"}")
        ...
        self.bt_parentesis_completo = QtWidgets.QPushButton(self.fr_789)
        self.bt_parentesis_completo.setMinimumSize(QtCore.QSize(78, 92))
        self.bt_parentesis_completo.setStyleSheet("QPushButton {\n"
...
"    background-color: rgb(139, 175, 191);\n"
"}")
        self.bt_parentesis_completo.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("vista/images/parentesis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bt_parentesis_completo.setIcon(icon7)
        self.bt_parentesis_completo.setIconSize(QtCore.QSize(48, 48))
        self.bt_parentesis_completo.setObjectName("bt_parentesis_completo")
        self.horizontalLayout_5.addWidget(self.bt_parentesis_completo)
...
"")
        ...
        self.bt_llaves_completo = QtWidgets.QPushButton(self.fr_456)
        self.bt_llaves_completo.setMinimumSize(QtCore.QSize(78, 92))
        self.bt_llaves_completo.setStyleSheet("QPushButton {\n"
"    background-color: rgb(26, 30, 39);\n"
"    border-radius: 15px;\n"
"    color: rgb(54, 105, 110);\n"
"}\n"
...
"    background-color: rgb(139, 175, 191);\n"
"}")
        self.bt_llaves_completo.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("vista/images/llaves.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bt_llaves_completo.setIcon(icon8)
        self.bt_llaves_completo.setIconSize(QtCore.QSize(48, 48))
        self.bt_llaves_completo.setObjectName("bt_llaves_completo")
        self.horizontalLayout_4.addWidget(self.bt_llaves_completo)
...
"")
        ...
        self.bt_corchetes_completo = QtWidgets.QPushButton(self.fr_123)
        self.bt_corchetes_completo.setMinimumSize(QtCore.QSize(78, 92))
        self.bt_corchetes_completo.setStyleSheet("QPushButton {\n"
"    background-color: rgb(26, 30, 39);\n"
"    border-radius: 15px;\n"
"    color: rgb(54, 105, 110);\n"
"}\n"
...
"    background-color: rgb(139, 175, 191);\n"
"}")
        self.bt_corchetes_completo.setText("")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("vista/images/corchetes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bt_corchetes_completo.setIcon(icon9)
        self.bt_corchetes_completo.setIconSize(QtCore.QSize(48, 48))
        self.bt_corchetes_completo.setObjectName("bt_corchetes_completo")
        self.horizontalLayout_3.addWidget(self.bt_corchetes_completo)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bt_pow.setShortcut(_translate("MainWindow", "Ctrl+P"))
